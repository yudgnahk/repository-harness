...
scripts/bin/harness-cli version       # Show version information for installed harness
scripts/bin/harness-cli outdated      # Check if a newer harness version is available
